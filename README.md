...
This project provides a simple Flask application that searches Google Places in multiple cities for multiple keywords and displays the results on an interactive Google Map.
